/**
 * Payment processor for MateableCoin (adapted from cryptonote-nodejs-pool, GPL-2.0).
 *
 * MateableCoin payouts are ordinary wallet transactions: all miners that are due are paid in ONE
